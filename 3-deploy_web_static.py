#!/usr/bin/python3
""" Creates and distributes an archive to web servers, using 
created function deploy and pack"""
    ...
    try:
        try:
            if os.path.exists(archive_path):
                ...
                """To upload archive to the server"""
                put(archive_path, '/tmp')

                """To save the folder paths in variables"""
